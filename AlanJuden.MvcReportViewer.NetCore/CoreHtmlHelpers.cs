...
namespace AlanJuden.MvcReportViewer
{
	public static class CoreHtmlHelpers
	{
		public static HtmlString RenderReportViewer(this IHtmlHelper helper, ReportViewerModel model, int? startPage = 1)
		{
			...
			sb.AppendLine("	<div class='ReportViewer'>");
			sb.AppendLine("		<div class='ReportViewerHeader'>");

			sb.AppendLine($"			<div class='ParametersContainer {(model.ShowParametersInput ? "": "hidden")} col-sm-12'>");
			...
			sb.AppendLine("			<div class='ReportViewerToolbar'>");
