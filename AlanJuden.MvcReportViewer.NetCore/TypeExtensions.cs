...
namespace AlanJuden.MvcReportViewer
{
	public static class TypeExtensions
	{
		...
		{
			return System.Net.WebUtility.HtmlDecode(text.ToSafeString());
		}

		public static string UrlDecode(this string text)
		{
			return System.Net.WebUtility.UrlDecode(text.ToSafeString());
		}
		...
		// where T : Enum
		{
			return (
				...
				where GetName((Enum)enumItem).Equals(name, StringComparison.CurrentCultureIgnoreCase)
				select (T)enumItem
				).Single();
		}
	}
